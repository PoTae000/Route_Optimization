...
- แต่ละจุดแนะนำ ให้ใส่ <<ACTION:searchAndAdd|query=ชื่อจริงสถานที่|day=เลขวัน|lat=ละติจูด|lng=ลองจิจูด>>
- day คือเลขวันที่ (1, 2, 3...)
- lat, lng คือพิกัดโดยประมาณของสถานที่ (ทศนิยม 2 ตำแหน่ง) — ต้องใส่ทุกจุดเสมอ
- รวมที่เที่ยว ร้านอาหาร ที่พัก ในแต่ละวัน
- ใส่คำอธิบายสั้นๆ แต่ละจุด
- ห้ามประมาณ/คำนวณระยะทาง เวลาเดินทาง หรือค่าน้ำมันเอง ให้แนะนำผู้ใช้กด 'คำนวณเส้นทาง' หลังเพิ่มจุดแวะครบแล้ว เพื่อดูระยะทางและเวลาจริง
...
<<ACTION:searchAndAdd|query=หาดป่าตอง ภูเก็ต|day=1|lat=7.88|lng=98.29>>

**กลางวัน:** ร้านอาหารริมทะเล — อาหารทะเลสด
<<ACTION:searchAndAdd|query=ร้านอาหารทะเล ป่าตอง ภูเก็ต|day=1|lat=7.89|lng=98.30>>

**บ่าย:** ย่านเมืองเก่าภูเก็ต — ถนนถลาง สถาปัตยกรรมชิโน-โปรตุกีส
<<ACTION:searchAndAdd|query=ถนนถลาง เมืองเก่าภูเก็ต|day=1|lat=7.88|lng=98.39>>

## วันที่ 2 — เกาะและธรรมชาติ
<<ACTION:searchAndAdd|query=เกาะพีพี กระบี่|day=2|lat=7.74|lng=98.77>>
...
